    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <button onclick="addForm('{{ route('kustomisasi.store') }}')" class="btn btn-sm bg-gradient-success"><i class="fa fa-plus-circle"></i> Tambah</button>
                </div>
